...
export const LANG_EN = {
  ...
  'CLAIM_INTEREST': {
    ...
    'TIP': 'Tip',
    'NOTICE': 'Notice',
    'TIP_DESC': 'don\'t attempt to claim rewards smaller than 0.01 KMD. A fee you have to pay for transaction will be more or equal to the interest amount.',
    'NATIVE_INTEREST_CHANGE_DESC': 'It\'s likely that reward is going to be credited as a separate transaction to a newely created KMD address. This is how native implements interest claiming.',
  ...
  'API': {
    ...
    'UKNOWN_ERROR': 'An uknown error occured, transaction failed to send',
    'UNKNOWN_ERROR_VRSC': 'An unknown error occured, if you are sending mined funds, check that you have shielded them to a private address before attempting to send',
  ...
  'SEND': {
    ...
    'TRANSPARENT_BALANCE1':'ERROR 1 - Your transparent balance is: ',
    'TRANSPARENT_BALANCE2':'ERROR 2 - Your transparent balance is: ',
