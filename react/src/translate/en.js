...
const LANG_EN = {
  ...
  API: {
    ...
    'apiElectrumLock': 'Unable to flush Lite mode auth data',
    'apiElectrumLogout': 'Unable to end Lite mode session',
    ...
    'apiElectrumKeys': 'Unable to get Lite mode auth data',
  ...
  INDEX: {
    ...
    RESERVE_BALANCE: 'Verus Reserve Balance',
    ...
    MINING_AND_STAKING: 'Staking & Mining',
    MINING: 'Mining',
    IDLE: 'Idle',
    STAKING: 'Staking',
  ...
  ADD_COIN: {
    ...
    LITE_SPV: 'Lite (SPV)',
    LITE_NSPV: 'Lite (nSPV)',
    LITE_SPV_MODE_DESC: 'Lite (SPV) mode doesn\'t require any blockchain to be loaded locally. ' +
                     'All data is requested on demand from Electrum servers. SPV mode has higher network latency compared to native mode.',
    LITE_NSPV_MODE_DESC: 'nSPV enhances the normal "Simple Payment Verification" (SPV) technology available for a Smart Chain.',
    NONE: 'none (default)',
  ...
  DASHBOARD: {
    ...
    PRIVATE_TX: 'Private/Hidden Transaction',
    PUBLIC_TX: 'Public Transaction',
    RESERVE_TX: 'Verus Reserve Token Transaction',
  ...
  TOASTR: {
    ...
    SETTINGS_CACHE_RESET: '(n)SPV cache is cleared',
    ...
    SHIELD_SUCCESS:'Shield Successfull',
    SUCCESS: 'Success!'
  },
  COIN_WALLETS: {
  ...
  LOGIN: {
    QMENU_REMOVE_SPV: 'Remove all (n)SPV coins',
    ...
    NSPV_MODE_DESC_P1: 'If you need a quick, easy and anonymous access to your funds try',
    NSPV_MODE_DESC_P2: 'Lite (nSPV) mode',
    NSPV_MODE_DESC_P3: 'which doesn\'t require any blockchain to be loaded locally.',
    NSPV_MODE_DESC_P4: 'All data is requested on demand from nodes running on network. nSPV enhances the normal "Simple Payment Verification" (SPV) technology available for a Smart Chain.',
  ...
  SEND: {
    ...
    BALANCE_LESS_THAN_FEE: 'Balance is equal to or less than transaction fee of @template@, and no extra funds are available for fee',
    ...
    ENTER_T_ADDR: 'Enter Transparent address',
    ...
    SEND_OFF_CHAIN_TO_VRSC: 'Send to Verus chain',
    SEND_OFF_CHAIN: 'Send off chain',
    SEND_TO_CHAIN: 'Send to chain:',
    DESTINATION_CHAIN: 'Destination Chain',
    ORIGIN_CHAIN: 'Origin Chain',
    FROM_COIN: 'From Coin',
    TO_COIN: 'To Coin',
    SEND_TO_CHAIN_HOLDER: 'Enter chain and press connect',
    RECENT_PRICE_X: 'Recent Price: @template@',
    RECENT_PRICE: 'Recent price',
    CONVERT_AMOUNT_TO_X: 'Convert amount to @template@',
    CREATE_Z_ADDR_TO_SHIELD: 'Create a private (Z) address to be able to sheild mined funds in the receive menu',
    SEND_VRSC_TOKEN: 'Send Verus Reserve Token',
    CONVERT_AND_SEND: 'Convert & send',
    SEND: 'Send',
    TO_X_CHAIN: 'to @template@ chain',
  },
  FIAT_CURRENCIES: {
  ...
  PBAAS: {
    ...
    CREATE: 'Create',
    CONVERT: 'Convert',
    CONVERT_DISABLED: 'Load a PBaaS chain to use this menu',
    HELP: 'Help',
    NAME: 'Name',
    PREMINE: 'Premine',
    RESERVE: 'Verus Reserve Chain',
    INITIAL_RESERVE_BALANCE: 'Initial Reserve Balance',
    INITIAL_RESERVE_BALANCE_DESC: 'This number represents the amount that you will contribute towards your chain\'s reserve balance when it launches, which will be deducted from your @template@ balance. The lower your chain\'s reserves at any given time, the higher its converstion rate volatility will be.',
    INITIAL_RESERVE_BALANCE_HOLDER: 'Enter the amount you will contribute at first towards your chains @template@ reserves',
    CONVERSION_RATE: 'Initial Conversion Rate',
    CONVERSION_RATE_DESC: 'This will be the starting conversion rate of your chain to @template@, but its total value will remain equal to the balance of your reserves, which depends on the total number of people converting to and from it.',
    CONVERSION_RATE_HOLDER: 'Enter the starting price of your coin, asset or token in @template@',
    MIN_PRECONVERT: 'Minimum Pre-Convert',
    MIN_PRECONVERT_HOLDER: 'Enter the minimum total pre-converted @template@ your chain will need to launch',
    MIN_PRECONVERT_DESC: 'If your chain doesn\'t have at least this much @template@ converted to it during its public pre-convert, it will not launch and everyone who converted to it will be refunded.',
    MAX_PRECONVERT: 'Maximum Pre-Convert',
    MAX_PRECONVERT_HOLDER: 'Enter the maximum total pre-converted @template@ your chain will need to launch',
    MAX_PRECONVERT_DESC: 'Your chain will stop accepting pre-convert transactions when it reaches this much pre-converted @template@.',
    LAUNCH_OPTIONS: 'Launch Options',
    REWARD_STRUCTURE: 'Reward Structure',
    BILLING: 'Billing',
    NODES: 'Nodes',
    CONFIRM: 'Confirm',
    NAME_DESC: 'Create your chain\'s identity',
    PREMINE_DESC: 'Optionally allocate coins pre-launch',
    LAUNCH_DESC: 'Customize your launch procedure',
    REWARD_STRUCTURE_DESC: 'Configure your chain rewards for miners',
    BILLING_DESC: 'Create your billing plan',
    NODES_DESC: 'Add nodes to start on',
    CONFIRM_DESC: 'Make sure everything checks out',
    ...
    PREMINE_DESC: 'You can allocate your coins before launch with a premine. Here you can decide where those coins would go, and how many there would be.',
    RESERVE_DESC: 'You have the option to create a Verus reserve chain, allowing your coin, token, or asset to be converted to and from @template@ with virtually infinite on-chain liquidy at a rate determined by the total conversions to and from your chain.',
    INCLUDE_PREMINE: 'Include a premine?',
    IS_RESERVE_CURRENCY: 'Create a reserve currency',
    PUBLIC_PRECONVERT: 'Open your chain\'s reserve funding to a public preconvert',
    PUBLIC_PRECONVERT_DESC: 'With this enabled, anyone running @template@ will be able to convert their funds into your chain\'s asset/token/currency before it launches at a fixed rate. Their conversions will contribute to your chain\'s total reserve balance.',
    PAYMENT_ADDRESS: 'Chain Payment Address',
    PREMINE_AMOUNT: 'Premine Amount',
    CONVERTIBLE_AMOUNT: 'Convertible Amount',
    LAUNCH_FEE: 'Conversion Fee',
    PAYMENT_ADDRESS_HOLDER: 'Enter your chain\'s address. Reserves and premined funds will go here',
    ...
    LAUNCH_FEE_HOLDER: 'Enter the % conversion fee for each conversion that will go to the chain address',
    LAUNCH_FEE_DESC: 'This number is the % fee that will be taken from everybody\'s chain conversions and given to the chain address during your chain\'s pre-convert stage.',
    ...
    LINEAR: 'Linear',
    FREQUENCY: 'Decay Frequency (# of chain blocks per decay interval)',
    ...
    END_BLOCK: 'End Block',
    END_BLOCK_HOLDER: 'Enter the block height that ends this era',
    ADD_ERA: 'Add Era',
    VISUALIZE: 'Visualize',
    VISUALIZE_DESC: 'Visualize your reward structure on a 2D plot',
    INVALID_INITREWARD: 'Invalid initial reward, please enter a number greater than 0',
    INVALID_DECAY_TYPE: 'Please select a decay type',
    INVALID_END: 'Invalid end block, must be an integer greater than 0 or the previous end block',
    INVALID_MAGNITUDE: 'Invalid magnitude, must be a number greater than 0',
    INVALID_FREQUENCY: 'Invalid decay frequency, must be an integer greater than 0',
    COST_STRUCTURE: 'Cost Structure',
    COST_STRUCTURE_DESC: 'Here is where you outline your chain\'s cost structure, and how much you will be offering to pay for notarization. The inital cost is how much you will offer for '+
    'your first billing period, the length of which you decided below as well. For every billing period past the first, you will be able to decide how much you will offer after you start your chain.',
    INITIAL_NOTARIZATION_OFFER: 'Initial Notarization Offer',
    INITIAL_NOTARIZATION_OFFER_HOLDER: 'Amount to be paid for first billing period',
    ...
    INVALID_PERCENT: 'Please enter a valid percent',
    ...
    NODE_PAYMENT_ADDRESS: 'Payment Address',
    NODE_PAYMENT_ADDRESS_HOLDER: 'Enter the payment address of your node for receiving awards',
    ADD_NODE: 'Add Node',
    NODE: 'Node',
    PREMINE_QUESTION: 'Premine?',
    IS_RESERVE_CURRENCY_QUESTION: 'Reserve Currency?',
    NUMBER_OF_ERAS: 'Number of Reward Eras',
    NUMBER_OF_NODES: 'Number of Nodes',
    REQUIRED_FIELD: 'This is a required field',
    REQUIRED_FIELD_CONDITIONAL: 'This is a required field given what you have selected',
    INVALID_INFO: 'The information entered here is invalid or incomplete',
    CONFIRM_DATA: 'Data Confirmation',
    CONFIRM_DATA_DESC: 'Take some time to look over your parameters, press confirm when ready.',
    CHAIN_FOUND_DESC: 'Take some time to look over it\'s parameters, and press connect to connect.',
    ERROR_FETCHING_CHAIN: 'Cannot find chain information for ',
    CHAIN_FOUND: '@template@ chain found!',
    ...
    VRSC_TOKEN_BALANCE: 'Verus Token Balance',
    PRICE_DATA: 'Price Data (Latest — @template@)',
    LIMIT_CONVERT_HISTORY: 'Limit Conversion History',
    BUY: 'buy',
    SELL: 'sell',
    TYPE: 'Type',
    ...
    VALUE: 'Value (VRSC)',
    STATUS: 'Status',
    NO_LIMIT_ORDERS: 'No recent limit orders',
    HEIGHT: 'Height',
    PRE_LAUNCH: 'pre-launch',
    PRE_LAUNCH_DESC: 'This chain currently hasn\'t launched yet, but it should around @template@.',
    PRE_CONVERT: 'pre-convert',
    PRE_CONVERT_DESC: 'This chain is in its pre-convert stage, any funds you send to your address on it will be available for you to spend as soon as it either launches or fails (decided at block @template@).',
    RUNNING: 'running',
    RUNNING_DESC: 'This chain is operational as of block @template@',
    FAILED: 'failed',
    FAILED_DESC: 'This chain failed to reach its converted coin goal before its scheduled start at block @template@, and therefore has failed to launch. It is not recommended to send funds here, but if participated in its preconvert, you can get refunded.',
    FULLY_FUNDED: 'funded',
    FULLY_FUNDED_DESC: 'This chain has reached its maximum preconvert limit and will launch as scheduled at block @template@.',
    X_CHAIN_STATUS: '@template@ chain status:',
    CHAIN_STATUS: 'Chain Status',
    SYNCING: 'syncing...',
    SYNCING_DESC: '@template@ hasn\'t fully synced, so chain status is not yet available',
    EMMITED: 'Coins Emitted Since Launch',
    EMMITED_DESC: 'The total number of coins mined/staked since chain launch.',
    INITIAL_RATIO: 'Reserve Ratio at Launch',
    INITIAL_RATIO_INFO: 'The supply/reserve ratio of the chain at its launch date.',
    INITIAL_SUPPLY: 'Supply at Launch',
    INITIAL_SUPPLY_INFO: 'The supply of the chain at its launch date.',
    INITIAL_CONTRIBUTION: 'Initial Contribution',
    INITIAL_CONTRIBUTION_INFO: 'The amount of coins supplied towards the reserves by the whoever launched this chain.',
    MAX_PRECONVERT_INFO: 'The maximum amount of coins this chain would accept during its pre-launch fixed rate pre-convert.',
    MIN_PRECONVERT_INFO: 'The minimum amount of coins this chain would need sent to it during its pre-launch pre-convert in order to launch.',
    INITIAL_CONVERSION_RATE: 'Initial Conversion Rate',
    INITIAL_CONVERSION_RATE_INFO: 'The fixed price in @template@ that this chain would convert for during its pre-launch pre-convert.',
    LAUNCH_FEE_INFO: 'The % fee that goes to this chain\'s address from each conversion made during its pre-launch pre-convert.',
    RETURN_BASED_ON_RECENT_PRICE: 'Est. Tx Value',
    RETURN_BASED_ON_RECENT_PRICE_DESC: 'This value is (your transaction amount - (your transaction amount * launchfee/100)) * recent price',
    PRECONVERTED: 'Pre-Converted',
    PRECONVERTED_INFO: 'The total amount of fixed rate pre-converted funds so far.',
    CHAIN_ADDRESS: 'Chain Address',
    BEST_PRICE: 'Best Price',
    BEST_PRICE_INFO: 'The most verified price of this coin in @template@.',
    RESERVE_SUPPLY: 'Reserve Supply',
    RESERVE_SUPPLY_INFO: 'The most verified total supply of this chain\'s reserve.',
    SUPPLY: 'Supply',
    SUPPLY_INFO: 'The most verified total circulating supply of this chain.',
    EST_CURRENT_HEIGHT: 'Est. current @template@ height',
    EST_TIME_TO_LAUNCH: 'Est. time until launch',
    CANT_SEND_DESC: 'This chain is not in a state that is recommended to send to, as it not open for conversions at this time. Any funds sent to it could be lost.',
    RESERVE_CONFIRMATION: 'Reserve Data Confirmation',
    RESERVE_CONFIRMATION_DESC: 'This chain is a reserve chain, take a moment to look over its reserve parameters.',
