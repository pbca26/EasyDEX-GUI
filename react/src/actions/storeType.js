...
export const DASHBOARD_SET_COIN_TILE_ORDER = 'DASHBOARD_SET_COIN_TILE_ORDER';
...
export const BLUR_SENSITIVE_DATA = 'BLUR_SENSITIVE_DATA';
...
export const DASHBOARD_ETHEREUM_COINS = 'DASHBOARD_ETHEREUM_COINS';

/* exchanges */
export const EXCHANGES_CACHE = 'EXCHANGES_CACHE';
export const DASHBOARD_ACTIVE_EXCHANGES_ORDER_MODAL = 'DASHBOARD_ACTIVE_EXCHANGES_ORDER_MODAL';
export const DASHBOARD_EXCHANGES_TOS_MODAL = 'DASHBOARD_EXCHANGES_TOS_MODAL';
export const DASHBOARD_EXCHANGES_SUPPORTED_COINS_MODAL = 'DASHBOARD_EXCHANGES_SUPPORTED_COINS_MODAL';
export const EXCHANGES_COINSWITCH_COINS = 'EXCHANGES_COINSWITCH_COINS';

/*PBaaS*/
export const CHANGE_PBAAS_ACTIVE_SECTION = 'CHANGE_PBAAS_ACTIVE_SECTION';
export const UPDATE_PBAAS_FORM_STATE = 'UPDATE_PBAAS_FORM_STATE';
export const UPDATE_DEFINED_CHAINS = 'UPDATE_DEFINED_CHAINS';
export const PBAAS_ACTIVE_CHAININFO_MODAL = 'PBAAS_ACTIVE_CHAININFO_MODAL';
export const CHANGE_PBAAS_CONVERT_ACTIVE_SECTION = 'CHANGE_PBAAS_CONVERT_ACTIVE_SECTION';
export const UPDATE_PBAAS_QUICK_CONVERT_FORM_STATE = 'UPDATE_PBAAS_QUICK_CONVERT_FORM_STATE';
export const UPDATE_PBAAS_CC_FORM_STATE = 'UPDATE_PBAAS_CC_FORM_STATE';

/*Mining*/
export const UPDATE_MINING_INFO = 'UPDATE_MINING_INFO';
export const TOGGLE_MINING_OPTIONS = 'TOGGLE_MINING_OPTIONS';