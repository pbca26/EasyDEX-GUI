    ...
    <div className="extcoin-send-form">
      ...
      { !this.state.kvSend &&
        ...
        <div className={ this.state.shieldCoinbase ? 'hide' : "col-lg-12 form-group form-material" }>
          ...
          { (this.props.ActiveCoin.coin === 'VRSC' || this.props.ActiveCoin.coin === 'VERUSTEST') && (this.state.sendTo.length === 95 || this.state.sendTo.length === 77) && !this.state.shieldCoinbase &&
